    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <div>
            <button
              className=" w-full items-center hover:opacity-70 dark:text-yellow-600 dark:bg-white shadow-lg text-yellow-600 bg-black py-2 rounded-full "
              onClick={() => {
                setNewColumns((state) => [
                  ...state,
            ...
            <button
              ...
              className=" w-full items-center hover:opacity-70 dark:text-yellow-600 dark:bg-black shadow-lg mt-8 relative  text-yellow-600 bg-black py-2 rounded-full"
            >
              {type === "add" ? "Create New space" : "Save Changes"}
            </button>
          </div>
        </div>
      </div>
