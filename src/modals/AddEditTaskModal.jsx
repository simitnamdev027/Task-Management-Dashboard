    ...
    >
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          {subtasks.map((subtask, index) => (
            <div key={index} className=" flex items-center w-full ">
              <input
                ...
                type="text"
                value={subtask.title}
                className=" bg-transparent outline-none focus:border-0 flex-grow px-4 py-2 rounded-md text-sm  border-[0.5px] border-gray-600 focus:outline-yellow-600 outline-[1px]  "
                placeholder=" e.g Take coffee break"
              />
              <img
                src={crossIcon}
          ...
          <button
            className=" w-full items-center dark:text-yellow-600 dark:bg-white  text-white bg-black py-2 rounded-full "
            onClick={() => {
              setSubtasks((state) => [
                ...state,
                { title: "", isCompleted: false, id: uuidv4() },
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <button
            ...
            className=" w-full items-center text-white bg-yellow-600 py-2 rounded-full "
          >
